...
const HEADER_GRADIENT = 'linear-gradient(90deg, hsl(0, 0.00%, 0.00%) 0%, hsl(254, 63.90%, 45.70%) 35%, hsl(243, 67.50%, 24.10%) 65%, hsl(220, 36.00%, 4.90%) 100%)';
...
export default function DefiHeader() {
  ...
  const { balanceVisible, setBalanceVisible } = useDefiBalance();
    ...
    >
      <div className="flex items-center justify-between h-full px-6">
        <div className="flex items-center flex-shrink-0">
          ...
          >
            <div className="w-6 h-5 sm:w-6 sm:h-6 bg-blue-600 rounded-sm flex items-center justify-center">
            ...
            {isTrading && (
              <>
                <span
                  ...
                  style={{ boxShadow: '0 0 12px #ff90e0, 0 0 8px #ff90e0' }}
                />
