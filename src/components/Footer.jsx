    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-10 lg:mb-12">
          ...
          <div className="flex flex-col sm:col-span-2 lg:col-span-1 items-center sm:items-start">
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              <div className="w-6 h-6 sm:w-7 sm:h-7 bg-blue-600 rounded-sm flex items-center justify-center">
                <div className="w-3 h-3 sm:w-3.5 sm:h-3.5 border-2 border-white"></div>
              </div>
              <span className="text-lg sm:text-xl font-semibold text-gray-900">Blockchain.com</span>
            </div>
            <div className="w-28 h-28 sm:w-32 sm:h-32 lg:w-36 lg:h-36 bg-white border-2 border-gray-300 rounded mb-3 sm:mb-4 flex items-center justify-center p-2">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-900 mb-4 sm:mb-6">
              {t('footer.products')}
            </h3>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3 sm:space-y-4 text-sm text-gray-600 mb-4 sm:mb-6">
              <li>
            ...
            <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-900 mb-3 sm:mb-4">
        ...
        {/* Social Media Icons */}
        <div className="flex justify-center sm:justify-end mb-6 sm:mb-8 lg:mb-10">
          <div className="flex items-center gap-3 sm:gap-4">
            <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Twitter">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Instagram">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Facebook">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 sm:gap-6">
            <div className="flex flex-col gap-2 sm:gap-3 w-full md:w-auto">
              ...
              <p className="text-xs sm:text-sm text-gray-600">{t('footer.copyright')}</p>
            </div>
          </div>
        </div>
      </div>
